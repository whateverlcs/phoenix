...
<head>
	<meta charset="UTF-8">
	<title>Phoenix - Listagem de Produtos</title>
...
<h4>&nbsp&nbsp<img src="img/listar.ico" width="40px" height="40px" class="d-inline-block align-top" alt="Swing"><a class="card__title">GERENCIAMENTO DE PRODUTOS</a></h4>
</br>
</br>
</br>
<p>&nbsp&nbsp<img src="img/adicionar2.ico" width="20px" height="20px" class="d-inline-block align-top" alt="Swing"><a class="card__title" href="adicionar.php" style="font-size: 15px;">Adicionar Produtos</a></p>
</br>
<form>
        <table border='1px' class="table" style="background-color: white;">
          <thead> 
            <tr style="background-color: black; color: white;">
              ...
              <th scope="col">Condição do produto</th>
