...
<head>
	<meta charset="UTF-8">
	<title>Phoenix - Editar Produtos</title>
...
<h4>&nbsp&nbsp<img src="img/edit.ico" width="30px" height="30px" class="d-inline-block align-top" alt="Phoenix"><a class="card__title">EDITAR PRODUTO</a></h4>
<?php
        include 'include/conn.php';
        $id = $_GET['id'];
        echo "<form method='POST' id='formulario' enctype='multipart/form-data' action='edicao.produtos.php?id=".$id." '>";
  ...
  <div class="form-row col">
    ...
    <input type="text" class="form-control" id="id" name="id" value='<?php echo $dados["id_produto"] ?>' readonly>
    </div>
    <div class="form-group col-md-3">
      <label for="Nome do produto">Nome do produto</label>
    <input type="text" class="form-control" id="nomeprod" name="nomeprod" placeholder="Digite o nome do produto" value='<?php echo $dados["nomeprod"] ?>'>
    </div>
    <div class="form-group col-md-3">
    ...
    <input type="text" class="form-control" id="marca" name="marca" placeholder="Digite a marca do produto" value='<?php echo $dados["marca"] ?>'>
    </div>
  </div>
  <div class="form-row col">
    <div class="form-group col-md-3">
    ...
    <div class="form-group col-md-3">
      ...
      <input type="text" class="form-control" id="condicao" name="condicao" placeholder="Digite a condição do produto" value='<?php echo $dados["condicao"] ?>'>
    </div>
    <div class="form-group col-md-3">
      <label for="Imagem">Imagem</label>
      <?php
        echo "<fieldset width='200px'><img class='borda' src='uploadsprodutos/".$dados['imagem']."' width='170px'height='120px' /></fieldset>";
      ?>
    </br>
